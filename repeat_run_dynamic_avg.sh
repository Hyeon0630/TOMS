...
workloads=(0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 0.85 0.9)
networkUp=120
networkDown=120
seed=0
iterations=100
...
result_file="$output_dir/result_${networkUp}_${networkDown}_${iterations}_dynamic.txt"
...
for workload in "${workloads[@]}"; do
    ...
    for ((i = 1; i <= iterations; i++)); do
        ...
        # run "run.sh"
        output=$(./run_dynamic_scheduling.sh $workload $utilCpu $networkUp $networkDown $seed)
