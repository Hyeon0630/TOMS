...
echo "Workload Section Power Util CPU_Power Memory_Power Network_Power Offloading_Ratio CPU_Frequency_1 CPU_Frequency_0.564 CPU_Frequency_0.327 CPU_Frequency_0.25 CPU_Frequency_0.182 Period_Violation Cost" > $result_file
...
for workload in "${workloads[@]}"; do
    ...
    # sections=("Tovs" "DVFS")
    sections=("Tovs")
    metrics=("Power" "Util" "CPU_Power" "Memory_Power" "Network_Power" "Offloading_Ratio" "CPU_Frequency_1" "CPU_Frequency_0.564" "CPU_Frequency_0.327" "CPU_Frequency_0.25" "CPU_Frequency_0.182" "Period_Violation" "Cost")
